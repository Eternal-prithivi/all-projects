...
class SdkDeployContext:
    ...
    public_ip_name: str = ""
    vm_name: str = ""
    launched_vm_size: str = ""
    vm_public_ip: str = ""
    ssh_private_key_pem: str = ""
    azure_vm_principal_id: str = ""
    action_group_id: str = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for key, val in (
            ...
            ("gcp_sa_preset", self.gcp_sa_preset),
            ...
            ("launched_vm_size", self.launched_vm_size),
            ("vm_public_ip", self.vm_public_ip),
            ("ssh_private_key_pem", self.ssh_private_key_pem),
            ("azure_vm_principal_id", self.azure_vm_principal_id),
    ...
    def from_dict(cls, data: Optional[dict]) -> "SdkDeployContext":
        ...
        return cls(
            ...
            gcp_sa_preset=str(data.get("gcp_sa_preset") or ""),
            ...
            azure_location=str(data.get("azure_location") or ""),
            ...
            launched_vm_size=str(data.get("launched_vm_size") or ""),
            vm_public_ip=str(data.get("vm_public_ip") or ""),
            ssh_private_key_pem=str(data.get("ssh_private_key_pem") or ""),
            azure_vm_principal_id=str(data.get("azure_vm_principal_id") or ""),
