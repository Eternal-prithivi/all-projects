...
import HeaderGlobalSearchTrigger from './HeaderGlobalSearchTrigger.jsx';
...
export default function HeaderToolbarActions({
  ...
  return (
    <div className={className}>
      {showSearchTrigger && (
        <HeaderGlobalSearchTrigger className="header-search-trigger--compact" placeholder="Search" />
      )}
